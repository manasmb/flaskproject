...
from terps import app, db, bcrypt
from terps.forms import RegistrationForm, LoginForm, PostForm, UpdateAccountForm
from terps.models import User, Post
...
def register():
    ...
    if form.validate_on_submit():
        ...
        db.session.add(user)
        db.session.commit()
        flash(f'Account successfully created for {form.username.data}! PLease login', 'success')
